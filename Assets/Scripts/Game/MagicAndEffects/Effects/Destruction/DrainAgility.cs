...
namespace DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects
{
    ...
    {
        public static readonly string EffectKey = "Drain-Agility";
        ...
        public override TextFile.Token[] SpellMakerDescription => DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1522);
        public override TextFile.Token[] SpellBookDescription => DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1222);
    }
}
